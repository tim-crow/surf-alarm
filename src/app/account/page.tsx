              ...
              <div className="glass-dark p-4 rounded-lg">
                ...
                <div className="grid grid-cols-4 gap-2">
                  {[
                    ...
                    const isSelected = formData.minTide === preset.min && formData.maxTide === preset.max;
                    return (
                      <button
                        key={preset.label}
                        type="button"
                        onClick={() => setFormData(prev => ({ ...prev, minTide: preset.min, maxTide: preset.max }))}
                ...
                <p className="text-white/40 text-xs mt-2">
                  {formData.minTide === 0 && formData.maxTide === 2.5 ? 'Any tide' : `${formData.minTide.toFixed(1)}m – ${formData.maxTide.toFixed(1)}m`}
                </p>
              </div>
